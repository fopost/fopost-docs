...
The [agent](/guide/agent) drafts campaigns from your real material, in your [brand voice](/guide/brand-voices), native per network. Nothing it produces publishes without an approval, which is a rule rather than a setting.
