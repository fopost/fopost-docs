...
- **Monthly close.** On the 1st, the previous month's ledger becomes an itemized invoice (account-days, AI usage, and storage overage per workspace, minus the free credit), and the remainder is charged to the card on file
