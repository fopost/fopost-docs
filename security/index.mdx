...
- **Turning it off needs a code.** A code from the app or a backup code, so someone holding a session cannot quietly weaken the account. Every other session is signed out when you do
