...
What each network actually reports varies. See [Analytics](/guide/analytics) for what the numbers mean, and the [Analytics API](/api/analytics) for the shapes behind these commands.
