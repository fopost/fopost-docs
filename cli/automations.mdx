...
`fopost automations` drives existing [automations](/guide/automations); `fopost webhooks` manages outbound [webhook](/webhooks) subscriptions. Creating and editing automations themselves happens in the dashboard.
