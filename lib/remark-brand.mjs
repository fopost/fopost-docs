 ...
 *
 * A no-op only when a deployment is literally called OwlStack and serves the
 * owlstack.app hosts, which is the shape the content is written in.
 *
 ...
 * brand: every page under content/ names OwlStack and the owlstack.app hosts,
