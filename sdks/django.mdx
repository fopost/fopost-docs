...
Published on [PyPI](https://pypi.org/project/fopost-django/). Source and issues: [github.com/fopost/fopost-django](https://github.com/fopost/fopost-django). MIT licensed.
...
Posts, accounts, workspaces, labels, AI, inbox, ads, pagination, error classes, and retry behaviour all live in the parent SDK, and everything the [Python SDK page](/sdks/python) documents works through `fopost_django.client` unchanged.
