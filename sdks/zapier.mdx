...
The integration is a **private Zapier app** today, which means it works but is not searchable
in the Zap editor. Open the invite link and the FoPost triggers and actions appear in your
account straight away:

**https://zapier.com/developer/public-invite/245788/97efdb1a56eae2dbebd9a79b0ecca1d0/**

Listing it in the public App Directory is a separate step: Zapier requires at least three
accounts running live Zaps before it will review an integration for the directory.
