...
In your WordPress admin, go to **Plugins → Add New**, search for **FoPost for WooCommerce**, then install and activate it. WooCommerce must be active first. You can also download it from the [plugin directory](https://wordpress.org/plugins/fopost-for-woocommerce/).
