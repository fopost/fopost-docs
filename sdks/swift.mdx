...
| `client.inbox` | Comments, mentions and DMs as items, threads and conversations, the unread count, read marks, refresh, replies, state changes, hide, unhide, delete, and reply approvals |
