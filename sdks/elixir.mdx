...
| `FoPost.Inbox` | `list/2`, `threads/2`, `conversations/2`, `unread_count/2`, `accounts/2`, `platforms/1`, `mark_thread_read/2`, `refresh/2`, `update/3`, `reply/3`, `hide/2`, `unhide/2`, `delete/2`, `approvals/2`, `approve_reply/3`, `reject_reply/2` |
