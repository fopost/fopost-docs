...
`fopost` is the official Elixir package. It needs Elixir 1.15 or newer on OTP 25 or newer, and requests go out over [Req](https://hexdocs.pm/req), which pools connections through the Finch instance its own application starts, so nothing has to go in your supervision tree.
...
Published on [Hex](https://hex.pm/packages/fopost). Source and issues: [github.com/fopost/fopost-elixir](https://github.com/fopost/fopost-elixir). MIT licensed.
...
| `FoPost.Inbox` | `list/2`, `threads/2`, `conversations/2`, `unread_count/2`, `accounts/2`, `platforms/1`, `mark_thread_read/2`, `refresh/2`, `update/3`, `reply/3`, `hide/2`, `unhide/2`, `delete/2`, `like/2`, `unlike/2`, `pin/2`, `unpin/2`, `react/3`, `edit_comment/3`, `start_conversation/2`, `set_typing/3`, `approvals/2`, `approve_reply/3`, `reject_reply/2` |
| `FoPost.Ads` | `list/2`, `external/2`, `boostable/2`, `connections/2`, `sources/2`, `authorize_meta/2`, `delete_connection/3`, `boost/2`, `create/2`, `refresh/3`, `set_status/3`, `delete/3`, `audiences/2`, `create_audience/2`, `search_targeting/2`, `lead_forms/2`, `create_lead_form/2`, `leads/3` |

`FoPost.Ads.boost/2`, `create/2`, `set_status/3` and `delete/3` spend money, so they need the `publish` scope as well as `ads`.
