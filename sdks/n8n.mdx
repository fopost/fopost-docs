...
The **FoPost Trigger** node registers a [webhook](/api/webhooks) when the workflow is activated and removes it when the workflow is deactivated. Pick a workspace and the events you care about:
