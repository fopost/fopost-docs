...
| `inbox` | `list`, `threads`, `conversations`, `unreadCount`, `accounts`, `platforms`, `markThreadRead`, `refresh`, `update`, `reply`, `hide`, `unhide`, `delete`, `like`, `unlike`, `pin`, `unpin`, `react`, `editComment`, `startConversation`, `setTyping`, `listApprovals`, `approveReply`, `rejectReply` |
