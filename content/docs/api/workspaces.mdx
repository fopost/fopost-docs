...
How many workspaces you get depends on the plan, and extras can be added. See [Plans](/guide/plans/overview).
...
<Cards>
  ...
  <Card title="Workspaces guide" href="/guide/using-owlstack/workspaces" />
</Cards>
