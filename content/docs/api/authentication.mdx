...
Every request to the OwlStack API carries an API key in the `X-API-Key` header.
...
Open [app.owlstack.app](https://app.owlstack.app) and go to **Settings → API Keys**. When you create a key you choose two things:
