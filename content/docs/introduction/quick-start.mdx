...
Sign up at [app.owlstack.app](https://app.owlstack.app) — it's free to get started.
...
Go to [app.owlstack.app](https://app.owlstack.app) → **Settings → API Keys** and generate a new key.
