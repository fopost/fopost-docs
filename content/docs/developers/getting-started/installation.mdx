...
See the [Laravel quick start](./quick-start-laravel) for setup details.

## WordPress

Download the OwlStack plugin from the [OwlStack dashboard](https://app.owlstack.app) or install via Composer:
...
See the [WordPress quick start](./quick-start-wordpress) for setup details.

## Get your API key

1. Sign up at [app.owlstack.app](https://app.owlstack.app)
2. Create a project
3. Copy your API key from the project dashboard
4. Connect your social media platforms via OAuth

<Callout type="info" title="Free trial available">
