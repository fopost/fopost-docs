...
Download the plugin from the [OwlStack dashboard](https://app.owlstack.app) and upload it, or install via Composer:
...
1. Enter your **OwlStack API key** (get one from [app.owlstack.app](https://app.owlstack.app))
2. Your connected platforms will appear automatically based on what you've set up in the OwlStack dashboard

<Callout type="info" title="Platform connections">
...
- [WordPress Admin Panel](/sdks/wordpress/admin-panel) - Settings page walkthrough
- [WordPress Hooks](/sdks/wordpress/hooks) - Full hooks reference
- [WordPress REST API](/sdks/wordpress/rest-api) - REST endpoints
