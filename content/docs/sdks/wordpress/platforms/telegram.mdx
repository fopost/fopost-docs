---
title: Telegram
description: Configure Telegram in the FoPost WordPress plugin.
---

# Telegram

Configure the FoPost WordPress plugin to publish posts to your Telegram channels and groups.
...
Navigate to **FoPost > Telegram** in the WordPress admin.
...
1. Go to **FoPost > Telegram** in your WordPress admin
...
Once configured, Telegram appears as a toggle in the FoPost meta box on post edit screens.
...
Use the **Publish Now** button in the FoPost meta box to send a post to Telegram on demand.
...
fopost()->telegram('Check out this photo!', [
    'type' => 'photo',
    'url'  => 'https://example.com/image.jpg',
]);

// With inline keyboard buttons
fopost()->telegram('Visit our site', null, [
    [['text' => 'Open Website', 'url' => 'https://example.com']],
]);

// Override the target channel
fopost()->telegram('Hello!', null, null, [
