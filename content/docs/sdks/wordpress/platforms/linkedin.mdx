---
title: LinkedIn
description: Configure LinkedIn in the FoPost WordPress plugin.
---

# LinkedIn

Configure the FoPost WordPress plugin to publish posts to your LinkedIn personal profile or company page.
...
Navigate to **FoPost > LinkedIn** in the WordPress admin.
...
1. Go to **FoPost > LinkedIn** in your WordPress admin
...
Once configured, LinkedIn appears as a toggle in the FoPost meta box on post edit screens.

### Programmatic publishing

```php
// Simple LinkedIn post
fopost()->linkedin('Hello from WordPress!');

// Post with a link
fopost()->linkedin('Check out our latest article: https://example.com/post');
```
