---
title: Discord
description: Configure Discord in the FoPost WordPress plugin.
---

# Discord

Configure the FoPost WordPress plugin to publish posts to your Discord server channels.
...
4. Click **New Webhook**
5. Name it (e.g., "FoPost") and copy the **Webhook URL**
</Callout>
...
Navigate to **FoPost > Discord** in the WordPress admin.
...
1. Go to **FoPost > Discord** in your WordPress admin
...
Once configured, Discord appears as a toggle in the FoPost meta box on post edit screens.

### Programmatic publishing

```php
// Simple message
fopost()->discord('Hello from WordPress!');

// Message with embed
fopost()->discord('New blog post published!', [
    'type' => 'embed',
    'title' => 'My Post Title',
