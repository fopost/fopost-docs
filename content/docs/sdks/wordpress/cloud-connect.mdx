...
The FoPost plugin can connect your self-hosted WordPress site to the [FoPost Cloud dashboard](https://app.fopost.com), so posts you compose there are pushed to your site, as drafts or published immediately, your choice.
...
1. In [app.fopost.com](https://app.fopost.com), go to **Accounts** and choose **WordPress**
