...
2. Select **Self-hosted WordPress**
3. Paste your **site URL** and the **site token**, then click **Connect Site**

Your site appears as a connected channel, and you can include it when composing posts.
