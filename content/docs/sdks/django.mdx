...
That serves the receiver at `/fopost/webhook/`, reversible as `reverse("fopost:webhook")`. Register that URL as a [webhook](/api/webhooks) in the dashboard, copy the secret it shows you into `FOPOST["WEBHOOK_SECRET"]`, and connect a receiver:
